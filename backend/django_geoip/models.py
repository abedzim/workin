...
class Region(models.Model):
    ...
    """
    country = models.ForeignKey(Country, related_name='regions', on_delete=models.PROTECT)
...
class City(models.Model):
    ...
    """
    region = models.ForeignKey(Region, related_name='cities', on_delete=models.PROTECT)
