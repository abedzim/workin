...
from jet.dashboard.models import UserDashboardModules as UserDashboardModule
...
class DefaultIndexDashboard(Dashboard):
    ...
    def init_with_context(self, context):
        ...
        #self.available_children.append(MapChart)
        ...
        self.children.append(modules.Feed(
            _('Abed ZIM'),
            feed_url='https://www.lemonde.fr/videos/rss_full.xml',
            limit=5,
            column=1,
            order=1
        ))
