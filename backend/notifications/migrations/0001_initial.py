# Generated by Django 2.0.9 on 2019-06-16 00:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verb', models.CharField(choices=[('L', 'liked'), ('C', 'commented'), ('F', 'cavorited'), ('FL', 'started to follow you'), ('A', 'answered'), ('W', 'accepted'), ('E', 'edited'), ('K', 'also commented'), ('I', 'logged in'), ('O', 'logged out'), ('V', 'voted on'), ('S', 'shared'), ('U', 'created an account'), ('R', 'replied to')], max_length=1)),
