...
function comment_update_view(data) {
  ...
  var commentHTML = '<li class="comment-list__comment"><div class="we-comment"><div class="coment-head"><h5><a class="user" href="' + data.commenter_info.profile_url
                  + '">@' + data.commenter_info.username + '</a></h5></div><p class="comments">'
                  + data.commenter_info.comment_text +'</p></div></li>'
...
function update_follow_view(data) {
  ...
  $button.addClass('btn-light unfollow-user').removeClass('btn-primary follow-user');
...
function update_unfollow_view(data) {
  ...
  var $button = $('.follow__card#' + data.follow_profile_pk
                + ' .btn, .profile .follow-toggle__container .btn');
  $button.addClass('btn-primary follow-user').removeClass('btn-light unfollow-user');
  $button.text('Follow');
}
