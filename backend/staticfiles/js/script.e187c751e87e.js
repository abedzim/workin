...
//   $('.snotif').on("click",function(){
// 	$('.notifdr').toggleClass("active");
//   });
//------- remove class active on body


$(".snotif").on("click", function(){
	$(".notifdr").addClass('active');
	 $(".theme-layout").addClass('active');
	 return false;
 });

 $(".smessage").on("click", function(){
	$(".messagedr").addClass('active');
	 $(".theme-layout").addClass('active');
	 return false;
 });
...
$('.theme-layout').on("click",function(){
    ...
    $(".notifdr").removeClass('active');
    $(".messagedr").removeClass('active');
...
// Sticky Sidebar & header
	...
	if($(window).width() < 769) {
		jQuery(".sidebar").children().removeClass("stick-widget1");
	}

	if ($.isFunction($.fn.stick_in_parent)) {
		$('.stick-widget1').stick_in_parent({
			parent: '#page-contents',
			offset_top: 47,
		});
