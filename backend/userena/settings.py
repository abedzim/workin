...
USERENA_COVER_SIZE1 = getattr(settings,
                               'USERENA_MUGSHOT_SIZE',
                               180)

USERENA_COVER_SIZE2 = getattr(settings,
                               'USERENA_MUGSHOT_SIZE',
                               60)
...
USERENA_COVER_PATH = getattr(settings,
                               'USERENA_MUGSHOT_PATH',
                               'covers/')
...
USERENA_PROFILE_DETAIL_TEMPLATE = getattr(
    settings, 'USERENA_PROFILE_DETAIL_TEMPLATE', 'userena/profile.html')
